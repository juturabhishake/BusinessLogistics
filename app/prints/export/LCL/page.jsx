    ...
    const fetchLocations = async () => {
      try {
        const response = await fetch('/api/get_locations', {
          ...
          body: JSON.stringify({ RFQType: 'LCL',sc: secureLocalStorage.getItem("sc") }),
        } );
      ...
      <div className="card-header bg-[var(--bgBody)] text-white rounded-t-lg py-2 px-3">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
            <div className="flex flex-col">
              ...
              <p className="text-xs text-gray-100">"RFQ Export rates for dayjs(selectedDate).format("MMMM YYYY")"</p>
