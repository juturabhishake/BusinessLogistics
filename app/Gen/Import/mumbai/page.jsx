...
const MumbaiQuoteEntry = () => {
  ...
  const handleSave = async () => {
    ...
    const savePromises = tableData.map(row => {
      ...
      return fetch("/api/Gen/Mumbai_Quote/save", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handlePrint = () => {
    router.push('/Gen/Import/mumbai/print');
  };
    ...
    <div className="h-[calc(100vh-2rem)]">
      <div className="card shadow rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white h-full flex flex-col mx-auto">
        <div className="flex flex-wrap gap-2 card-header p-4 border-b border-gray-200 dark:border-gray-700 justify-between items-center">
          <div>
            <h2 className="text-xl font-bold">Mumbai to GTI Quotation Entry ({quoteYear})</h2>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <FiPrinter className="mr-2" /> View & Print
            </button>
            <button
              onClick={handleSave}
...
export default MumbaiQuoteEntry;