...
const MumbaiQuoteAdminView = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('/api/Gen/Mumbai_Quote/get_admin', {
          method: "POST",
  ...
  const handleExportPdf = () => {
    exportMumbaiAdminPdf(tableData, vendorColumns, selectedYear);
  };
    ...
    <div className="h-[calc(100vh-2rem)]">
      <div className="card shadow rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white h-full flex flex-col mx-auto">
        <div className="flex flex-wrap gap-4 card-header p-4 border-b border-gray-200 dark:border-gray-700 justify-between items-center">
          <div>
            <h2 className="text-xl font-bold">Mumbai to GTI - Admin Comparative Statement</h2>
...
export default MumbaiQuoteAdminView;